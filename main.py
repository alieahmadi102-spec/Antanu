...
BASE_SYSTEM_PROMPT = (
    ...
    "بخش سوم = تلفظ به حروف انگلیسی/فنگلیش (اگر تلفظ نداشتی، این بخش را خالی بگذار ولی «||» را نگه دار). "
    "جداکننده‌ی بخش‌ها دقیقاً دو خط عمودی «||» است. "
    "برای ترجمه‌ی «کلمه‌به‌کلمه»، برای هر واژه یک بلوک [[TR:...]] جداگانه بده و برای تک‌واژه‌ها بخش اول (خود کلمه) و بخش سوم (تلفظ فنگلیش) را حتماً پر کن؛ خالی نگذار. "
    "برای «متن طولانی»، یک بلوک [[TR:...]] بده که بخش دومش کل متنِ ترجمه‌شده باشد. "
    "می‌توانی قبل از بلوک‌ها یک جمله‌ی کوتاه توضیحی بنویسی، اما خودِ ترجمه فقط داخل [[TR:...]] باشد، نه داخل جمله."
)
