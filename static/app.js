...
function renderMD(text) {
  ...
  // کارت‌های ترجمه: فقط باکس کپیِ معنی + تلفظ فنگلیش (خط «کلمه» و برچسب «معنی» به‌خواست کاربر حذف شد)
...
/* انتخاب زبان: خودِ منو با onchange به /lang/<code> می‌رود — آن مسیر هم کوکی را
   می‌گذارد، هم برای کاربر وارد‌شده زبان را در حساب ذخیره می‌کند، هم به همان
   صفحه برمی‌گردد. پس اینجا کد جاوااسکریپتی لازم نیست و بدون JS هم کار می‌کند. */
